    ...
    <div class="dashboard-content-wrap">
        <div class="container-fluid">
            ...
            @if(count($assignment->questions) > 0)
                @foreach($assignment->questions as $index => $qestion)
                    <div class="row mt-3">
                        <div class="col-lg-12">
                            <div class="card-box-shared">
                                ...
                                <div class="card-box-shared-body">
                                    <div class="user-form">
                                        <form
                                            action="{{ route('teacher.courses.assignments.update_questions', ['course' => $course->slug, 'assignment' => $assignment->id, 'question' => $qestion->id]) }}">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="sort-ordering user-form-short">
                                                                    <select class="sort-ordering-select"
                                                                            name="assignment_section_id"
                                                                            id="assignment_section">
                                                                        @foreach($assignment->sections as $section)
                                                                            <option
                                                                                value="{{ $section->id }}" {{ $qestion->assignment_section_id == $section->id ? 'selected' : '' }}>{{ $section->title }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                    <span
                                                                        class="text-danger font-size-12 d-none"></span>

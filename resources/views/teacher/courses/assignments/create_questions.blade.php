...
@section('content')
    <div class="dashboard-content-wrap">
        <div class="container-fluid">
            ...
            @endif
            <form
                action="{{ route('teacher.courses.assignments.store_questions', ['course' => $course->slug, 'assignment' => $assignment->id]) }}"
                                                    ...
                                                    <div class="form-group">
                                                        <div class="sort-ordering user-form-short">
                                                            <select class="sort-ordering-select"
                                                                    name="section_ids[]" id="assignment_section">

...
@section('title', setting('website_name') . ' Create Assignment Sections')
@section('content')
                ...
                <div class="col-lg-12">
                    <div class="card-box-shared">
                        <div class="card-box-shared-title">
                            <h3 class="widget-title">@lang('site.assignment_sections')</h3>
                        </div>
                        <div class="card-box-shared-body">
                            <div class="user-form">
                                <div class="contact-form-action">
                                    <form method="post"
                                          action="{{ route('teacher.courses.assignments.store_sections', ['course'=>$course->slug, 'assignment' => $assignment->id]) }}"

...
@section('title', setting('website_name') . ' Add Question to assignment')
@section('content')
            ...
            <div class="row mt-3">
                <div class="col-lg-12">
                    <div class="card-box-shared">
                        ...
                        <form
                            action="{{ route('teacher.courses.assignments.store_question', ['course' => $course->slug, 'assignment' => $assignment->id]) }}"
                            ...
                            <div class="card-box-shared-body">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="sort-ordering user-form-short">
                                                            <select
                                                                ...
                                                                name="section_id" id="assignment_section">
                                                                @foreach($sections as $section)
                                                                    <option
                                                                        value="{{ $section->id }}">{{ substr($section->title, 0, 50) }} {{ strlen($section->title) > 50 ? " ..." : "" }}</option>
                                                                @endforeach
                                                            </select>
                                                            @error('section_id')
                                                            <span
                                ...
                                <button type="submit"
                                        class="theme-btn">@lang('site.add_question_to_assignment')</button>
                                ...
                                <table class="table">
                                    ...
                                    @forelse($questions as $question)
                                        <tr>
                                            ...
                                            <td>{{ substr($question->section->title, 0, 30) }} {{ strlen($question->section->title) > 30 ? " ..." : "" }}</td>
                                            <td>{{ __('site.' . $question->type) }}</td>
                                            <td>{{ $question->mark }}</td>
                                            <td>
                                                <a href="{{ route('teacher.courses.assignments.edit_question', ['course' => $course->slug, 'assignment' => $assignment->id, 'question' => $question->id]) }}">
                                                ...
                                                <form
                                                    class="d-inline"
                                                    action="{{ route('teacher.courses.assignments.delete_question', ['course' => $course->slug, 'assignment' => $assignment->id, 'question' => $question->id]) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('delete')
...
@push('scripts')
    ...
    <script>
        ...
        let assignment_sections_options = $('#assignment_section').html();

                ...
                <div class="col-lg-12">
                    <div class="card-box-shared">
                        <div class="card-box-shared-title d-flex justify-content-between">
                            <h3 class="widget-title">@lang('site.edit_questions')</h3>
                        </div>
                        <form
                            action="{{ route('teacher.courses.assignments.update_question', ['course' => $course->slug, 'assignment' => $assignment->id, 'question' => $question->id]) }}"
                                                        ...
                                                        <div class="sort-ordering user-form-short">
                                                            <select
                                                                ...
                                                                @foreach($sections as $section)
                                                                    <option
                                                                        value="{{ $section->id }}" {{ $question->section_id == $section->id ? 'selected' : '' }}>
        ...
        $(document).on('change', '.type', function () {
            ...
            if (selected_value === 'mcq') {
                ...
                $(this).parent().parent().parent().parent().parent().siblings('.mcq').append(`
                    <div class="input-box">
                        <label class="label-text">@lang('site.choices') <span class="primary-color-2 ml-1">*</span></label>
                        <div class="form-group">
                            <div class="row align-items-center">
                                <div class="col-1">
                ...
                $(this).parent().parent().parent().parent().parent().siblings('.true_false').append(`
                    <div class="input-box">
                        <label class="label-text">@lang('site.correct_answer') <span class="primary-color-2 ml-1">*</span></label>
                        <div class="form-group">
                            <select name="correct_answer"
                                    class="form-control">

                        ...
                        <div class="card-box-shared-body">
                            <div class="user-form">
                                <div class="contact-form-action">
                                    <form method="post"
                                          action="{{ route('teacher.courses.assignments.store', $course->slug) }}"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-sm-12">
                                                <div class="input-box">
                                                    <label class="label-text">
                                                        @lang('site.assignment_name')
                                                        <span class="primary-color-2 ml-1">*</span>
                                                    </label>
                                                    <div class="form-group">
                                                        <input class="form-control @error('name') error @enderror"
                                                               type="text" name="name"
                                                               placeholder="@lang('site.assignment_name')"
                                                               value="{{ old('name') }}"
                                                        >
                                            ...
                                            <div class="col-lg-6 col-sm-6">
                                                <div class="input-box">
                                                    <label class="label-text">@lang('site.assignment_start_date')<span
                                                            class="primary-color-2 ml-1">*</span></label>
                                                    <div class="form-group">
                                                        <input
                                                            class="form-control datepicker1 @error('start_date') error @enderror"
                                                            type="text" name="start_date"
                                                            placeholder="@lang('site.assignment_start_date')"
                                            ...
                                            <div class="col-lg-6 col-sm-6">
                                                <div class="input-box">
                                                    <label class="label-text">@lang('site.assignment_start_time')<span
                                                            class="primary-color-2 ml-1">*</span></label>
                                                    <div class="form-group">
                                                        <input
                                                            class="form-control @error('start_time') error @enderror"
                                                            type="time" name="start_time"
                                                            placeholder="@lang('site.assignment_start_time')"
                                            ...
                                            <div class="col-lg-6 col-sm-6">
                                                <div class="input-box">
                                                    <label class="label-text">@lang('site.assignment_end_date')<span
                                                            class="primary-color-2 ml-1">*</span></label>
                                                    <div class="form-group">
                                                        <input
                                                            class="form-control datepicker2 @error('end_date') error @enderror"
                                                            type="text" name="end_date"
                                                            placeholder="@lang('site.assignment_end_date')"
                                                            value="{{ old('end_date') }}"
                                                        >
                                                        <span class="las la-calendar input-icon"></span>
                                                        @error('end_date')
                                            ...
                                            <div class="col-lg-6 col-sm-6">
                                                <div class="input-box">
                                                    <label class="label-text">@lang('site.assignment_end_time')<span
                                                            class="primary-color-2 ml-1">*</span></label>
                                                    <div class="form-group">
                                                        <input
                                                            class="form-control @error('end_time') error @enderror"
                                                            type="time" name="end_time"
                                                            placeholder="@lang('site.assignment_end_time')"
                                                            value="{{ old('end_time') }}"
                                                        >
                                                        <span class="las la-calendar input-icon"></span>
                                                        @error('end_time')
                                            ...
                                            <div class="col-lg-12 col-sm-12">
                                                <div class="input-box">
                                                    <label class="label-text">@lang('site.assignment_description')
                                                        <span class="primary-color-2 ml-1">*</span>
                                                    </label>
                                                    <div class="form-group">
                                                        <textarea
                                                            ...
                                                            placeholder="@lang('site.assignment_description')">{{ old('description') }}</textarea>

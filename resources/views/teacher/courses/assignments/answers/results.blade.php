                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="quiz-content text-center">
                            @php
                                $percentage = number_format($assignment_attempt->mark  / $assignment->total_mark * 100, 2);
                            @endphp
                            ...
                            <p class="lead font-weight-regular font-size-18 text-color-rgba mb-0 pb-2">
                                @lang('site.scores'): {{ $assignment_attempt->mark }}/{{ $assignment->total_mark }}
                            </p>
                        </div>
                    </div><!-- end col-lg-12 -->
                </div><!-- end row -->
        ...
        <div class="quiz-ans-wrap padding-top-80px padding-bottom-80px">
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <button class="theme-warning-btn" onclick="window.history.back();">

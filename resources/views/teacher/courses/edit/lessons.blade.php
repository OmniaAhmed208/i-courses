            ...
            <div class="row my-3">
                <div class="col-lg-12 text-center">
                    <a href="{{ route('teacher.courses.index') }}">
                        <button class="theme-warning-btn" type="submit">
...
`)
        ...
        $(document).on('click', '.upload', function (e) {
            ...
            formData.append("description", form.children('.form-content').children('.col-lg-12').children('.input-box').children('.form-group').children('textarea[name="description"]').val());
                    ...
                    for (var i = 0; i < keys.length; i++) {
                        ...
                        switch (keys[i]) {
                            ...
                            case "time":
                                ...
                                break;
                            case "description":
                                form.children('.form-content').children('.col-lg-12').children('.input-box').children('.form-group').children('textarea[name="description"]').siblings('span.error_message').html(error_msg);
                                break;
                            case "is_free":

...
@section('title', setting('website_name') . ' Edit Answer')
@section('content')
                ...
                <div class="col-lg-12">
                    <div class="card-box-shared">
                        <div class="card-box-shared-title d-flex justify-content-between">
                            <h3 class="widget-title">@lang('site.edit_answer')</h3>
                        </div>
                        <form
                            action="{{ route('teacher.courses.qas.update', ['course' => $course->slug, 'qa' => $qa->id]) }}"
                            method="POST">
                            @csrf
                            @method('PUT')
                            <div class="card-box-shared-body">
                                                ...
                                                <div class="input-box">
                                                    ...
                                                    <div class="form-group">
                                                        <textarea name="answer" id="answer" rows="7"
                                                                  class="form-control @error('answer') error @enderror">{{ $qa->answer }}</textarea>
                                ...
                                <button type="submit" class="theme-btn">@lang('site.edit_answer')</button>

                        ...
                        <div class="card-box-shared-body">
                            <div class="statement-table withdraw-table table-responsive mb-5">
                                <div class="row mb-4 flex-row-reverse">
                                    <div class="col">
                                        <form
                                            action="{{ route('admin.courses.groups.delete_all_students', ['course' => $course->slug, 'group' => $group->id]) }}"
                                        ...
                                        <form
                                            action="{{ route('admin.courses.groups.unblock_all_students', ['course' => $course->slug, 'group' => $group->id]) }}"
                                            method="POST" class="d-inline-block mb-2">
                                            @csrf
                                        ...
                                        <form
                                            action="{{ route('admin.courses.groups.block_all_students', ['course' => $course->slug, 'group' => $group->id]) }}"
                                            method="POST" class="d-inline-block mb-2">
                                            @csrf

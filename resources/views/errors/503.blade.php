...
<div class="container">
    <div class="d-flex align-center flex-column w-100">
        <div class="col-L">
            <img src="{{ setting('website_logo') ? asset(setting('website_logo')) : asset('images/logo.png') }}"
                 alt="Logo" style="width: 90px">
            <h1>@lang('site.under_maintenance')</h1>
            <h2>@lang('site.maintenance_p')</h2>
            <hr>
            <p>@lang('site.maintenance_footer')</p>
        </div>
        <div class="col-R">
            <svg x="0px" y="0px" viewBox="0 0 219.9 219.9" style="enable-background:new 0 0 219.9 219.9;">
                <g>
                    <path class="st0-{{ setting('website_color') }}"

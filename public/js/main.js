/*---------------------------------------------
Template name:  MAX
Description: MAX - Education HTML5 Template
Version:        2.0
Author:         TechyDevs
...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '.humburger-menu .humburger-menu-lines', function () {
        ...
        $('.resources_input').filer({
            limit: 10,
            maxSize: 500,
            showThumbs: true,
            extensions: ['pdf', 'doc', 'docx', 'xls', 'xlsx', 'ppt', 'pptx', 'csv', 'jpg', 'jpeg', 'png'],
            captions: {
                errors: {
                    filesLimit: "Only {{fi-limit}} files are allowed to be uploaded.",
                    filesType: "Only ('pdf', 'doc', 'docx', 'xls', 'xlsx', 'ppt', 'pptx', 'csv', 'jpg', 'jpeg', 'png') extensions are allowed to be uploaded.",
                    filesSize: "{{fi-name}} is too large!Please upload file up to {{fi-maxSize}} MB.",
                    filesSizeAll: "Files you've choosed are too large!Please upload files up to {{fi-maxSize}} MB."
                }
            }
        ...
        $('.excel_input').filer({
            ...
            captions: {
                errors: {
                    filesLimit: "Only {{fi-limit}} files are allowed to be uploaded.",
                    filesType: "Only ('xls', 'xlsx') extensions are allowed to be uploaded.",
                    filesSize: "{{fi-name}} is too large!Please upload file up to {{fi-maxSize}} MB.",
                    filesSizeAll: "Files you've choosed are too large!Please upload files up to {{fi-maxSize}} MB."
                }
            }
